...
const router_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@keplr-wallet/router'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
const enigma_1 = __webpack_require__(/*! ./enigma */ "../provider/build/enigma.js");
const cosmjs_1 = __webpack_require__(/*! ./cosmjs */ "../provider/build/cosmjs.js");
...
class Keplr {
    ...
    signDirectAux(chainId, signer, signDoc, signOptions = {}) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, router_1.sendSimpleMessage)(this.requester, router_1.BACKGROUND_PORT, "keyring-cosmos", "request-cosmos-sign-direct-aux", {
                chainId,
                signer,
                signDoc: {
                    bodyBytes: signDoc.bodyBytes,
    ...
    signEthereum(chainId, signer, message, signType) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, router_1.sendSimpleMessage)(this.requester, router_1.BACKGROUND_PORT, "keyring-ethereum", "request-sign-ethereum", {
                chainId,
                signer,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./core */ "../provider/build/core.js"), exports);
__exportStar(__webpack_require__(/*! ./cosmjs */ "../provider/build/cosmjs.js"), exports);
__exportStar(__webpack_require__(/*! ./enigma */ "../provider/build/enigma.js"), exports);
__exportStar(__webpack_require__(/*! ./inject */ "../provider/build/inject.js"), exports);
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../provider/build/inject.js":
/*!***********************************!*\
  !*** ../provider/build/inject.js ***!
  \***********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                const result = yield (() => __awaiter(this, void 0, void 0, function* () {
                    if (method === "signDirect") {
                        return yield (() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            // signDirect takes 4 arguments
                            // calling the keplr background service
                            const result = yield keplr.signDirect(message.args[0], //chainId
                            message.args[1], //signer
                            {
...
"use strict";
module.exports = JSON.parse('{"manifest_version":2,"name":"Keplr","description":"Keplr is a browser extension wallet for the Inter blockchain ecosystem.","version":"0.12.70","icons":{"16":"assets/icon-16.png","48":"assets/icon-48.png","128":"assets/icon-128.png"},"browser_action":{"default_popup":"popup.html","default_title":"Keplr"},"background":{"page":"background.html","persistent":true},"permissions":["storage","notifications","identity","idle","alarms","unlimitedStorage"],"content_scripts":[{"matches":["<all_urls>"],"js":["browser-polyfill.js","contentScripts.bundle.js"],"run_at":"document_start","all_frames":true}],"web_accessible_resources":["injectedScript.bundle.js"]}');
...
"use strict";
/*!*******************************************************!*\
  !*** ./src/content-scripts/inject/injected-script.ts ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _keplr_wallet_provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @keplr-wallet/provider */ "../provider/build/index.js");
...
/* harmony import */ var _manifest_v2_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../manifest.v2.json */ "./src/manifest.v2.json");



const keplr = new _keplr_wallet_provider__WEBPACK_IMPORTED_MODULE_0__.InjectedKeplr(_manifest_v2_json__WEBPACK_IMPORTED_MODULE_1__.version, "extension");
(0,_keplr_wallet_provider__WEBPACK_IMPORTED_MODULE_0__.injectKeplrToWindow)(keplr);

})();

/******/ })()
;
//# sourceMappingURL=injectedScript.bundle.js.map